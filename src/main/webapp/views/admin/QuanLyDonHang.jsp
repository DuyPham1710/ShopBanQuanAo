			  ...
			  <div class="card mb-4">
			    <div class="card-body d-flex justify-content-between align-items-center">
			      <div>
			        ...
			        <h2 class="font-weight-bold">${DonDangChoXacNhan}</h2>
			      </div>
			  ...
			  <div class="card mb-4">
			    <div class="card-body d-flex justify-content-between align-items-center">
			      <div>
			        ...
			        <h2 class="font-weight-bold">${DonDangGiao}</h2>
			      </div>
			  ...
			  <div class="card mb-4">
			    <div class="card-body d-flex justify-content-between align-items-center">
			      <div>
			        ...
			        <h2 class="font-weight-bold">${DonDaGiao}</h2>
			      </div>
			  ...
			  <div class="card mb-4">
			    <div class="card-body d-flex justify-content-between align-items-center">
			      <div>
			        ...
			        <h2 class="font-weight-bold">${DonDaHuy}</h2>
			      </div>
